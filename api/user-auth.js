...
const USER_PASSWORD_HASH = process.env.USER_PASSWORD_HASH || '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy'; // 'test123'
            ...
            try {
                ...
                if (isValid) {
                    ...
                    res.setHeader('Set-Cookie', 
                        `user-auth=${sessionToken}; HttpOnly; Secure; SameSite=Strict; Path=/; Max-Age=${SESSION_DURATION / 1000}`
                    );
